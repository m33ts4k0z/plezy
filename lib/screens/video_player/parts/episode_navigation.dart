...
extension _VideoPlayerEpisodeNavigationMethods on VideoPlayerScreenState {
  ...
  Future<_MediaReloadOutcome> _reloadMediaInPlace({
    ...
    try {
      ...
      final previousTranscodeClient = _playbackSession?.reportingClient;
      final previousSessionWasTranscoding = _isTranscoding;
      final targetTranscodeSessionId = targetQualityPreset.isOriginal
          ? previousTranscodeSessionId
      ...
      try {
        ...
        final playbackContext = await playbackResolver.resolve(
          PlaybackInitializationOptions(
            ...
            transcodeSessionId: targetTranscodeSessionId,
          ),
        ...
        if (!targetQualityPreset.isOriginal) {
          _playbackTranscodeSessionId = targetTranscodeSessionId;
        }
        if (previousSessionWasTranscoding && previousTranscodeClient is PlexClient) {
          unawaited(previousTranscodeClient.stopTranscodeSession(transcodeSessionId: previousTranscodeSessionId));
        }
