...
class _PlaybackSettingsScreenState extends State<PlaybackSettingsScreen> {
  ...
  Widget _themeMusicTile() => SettingSelectionTile<ThemeMusicLevel>(
    ...
    options: ThemeMusicLevel.values
        .map(
          (level) =>
              DialogOption(value: level, title: _themeMusicLabel(level), subtitle: _themeMusicDescription(level)),
        )
        .toList(),
  );
