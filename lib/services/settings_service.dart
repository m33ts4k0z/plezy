...
class SettingsService extends BaseSharedPreferencesService {
  ...
  static const downloadStorageLimitGb = IntPref('download_storage_limit_gb', transform: _clampNonNegative);
  ...
  static const themeMusicLevel = EnumPref<ThemeMusicLevel>(
    'theme_music_level',
  ...
  static final plexDownloadQueueIds = JsonPref<Map<String, int>>(
    ...
    defaultValue: const {},
    encode: json.encode,
    decode: (raw) => (raw as Map<String, dynamic>).map((key, value) => MapEntry(key, value as int)),
  );
