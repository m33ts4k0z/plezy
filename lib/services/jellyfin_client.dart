...
class JellyfinClient
  ...
  /// Fetch raw thumbnail bytes for the persistent-media-notification feature.
  /// The Android MediaSession plugin can't read authenticated URLs directly,
  /// so we pre-fetch artwork as bytes through the [MediaServerHttpClient]
  /// (which carries the access token) before handing it to native.
  @override
